...
*/
define(['cUIBase', 'libs'], function (Tools, libs) {
  ...
  var History = function (options) {
    ...
    this.clearHistoryAction = function () { };
  ...
  History.prototype = {
    ...
    _BuildEvent: function () {
      ...
      this._clearButton.unbind('click');
      this._clearButton.bind('click', function () {
        self.historyStore.remove();
        self.Close();
        self._init();
        if (self.clearHistoryAction && self.clearHistoryAction.call(self));
      });
      //        }
      //      }
    },
